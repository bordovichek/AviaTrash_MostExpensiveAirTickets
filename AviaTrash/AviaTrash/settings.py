"""
Django settings for AviaTrash project.
...
SECRET_KEY = 'django-insecure-7u@eiqn_uz*wtsbb81b0l86fi7^$&yti^6$=ux+d__(azm3o5t'
...
WSGI_APPLICATION = 'AviaTrash.wsgi.application'
